...
public class UserRoleDao extends BaseDao {
    ...
    public List<UserRole> findAllUserRoles() {
        return super.getHibernateTemplate().find("FROM UserRole");
    }
    ...
    public UserRole findUserRoleByUserRole(String userRole) {
        List<UserRole> list = super.getHibernateTemplate().find(
                "FROM UserRole f WHERE f.userRole=?", userRole);
    ...
    public List<UserRole> findUserRolesByRoleName(String roleName) {
        List<UserRole> list = super.getHibernateTemplate().find(
                "FROM UserRole f WHERE f.roleName=?", roleName);
        return list;
    }
    ...
    public List<UserRole> findUserRolesByUsername(String username) {
        ...
        return super.getHibernateTemplate().findByExample(userRole);
    }
