...
public class ResetPasswordAction extends BaseAction {
    ...
    public String doReset() {
        ...
        // .getContext().getAuthentication().getPrincipal(); // TODO String
        // user_name = userDetails.getUsername(); String password =
        ...
        //
        // int i = 0; // userService.updateUserPassword(user_name,
        // resetPasswordVo.getNewPassword()); // return 0, update success if (1
        // ==
        // i) { addActionMessage("Password Reset Success!");
        // System.out.println("############# success"); } else {
        // addActionMessage("Password Reset Failure!");
        // System.out.println("############# Failure"); }
        //
        // } else { // public static final java.lang.String INPUT = "input";
