...
CREATE TABLE `t_user` (
  ...
  `update_at` datetime DEFAULT NULL,
  PRIMARY KEY (`user_id`)
) ENGINE=InnoDB AUTO_INCREMENT=7 DEFAULT CHARSET=utf8 COLLATE=utf8_bin COMMENT='user''s basic information';
...
-- ----------------------------
INSERT INTO `t_user_level` VALUES ('1', '钻石会员', '8.00', '10000', '1', null, null, null, null, null);
INSERT INTO `t_user_level` VALUES ('2', '白金会员', '8.50', '7500', '1', null, null, null, null, null);
INSERT INTO `t_user_level` VALUES ('3', '金牌会员', '9.00', '5000', '1', null, null, null, null, null);
INSERT INTO `t_user_level` VALUES ('4', '普通会员', '9.50', '0', '1', null, null, null, null, null);
